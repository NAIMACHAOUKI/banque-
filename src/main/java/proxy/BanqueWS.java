 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://BankServices/", wsdlLocation = "http://localhost:9191/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUEWS_QNAME = new QName("http://BankServices/", "BanqueWS");
    ...
    public BankService getBankServicePort() {
        return super.getPort(new QName("http://BankServices/", "BankServicePort"), BankService.class);
    }
    ...
    public BankService getBankServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://BankServices/", "BankServicePort"), BankService.class, features);
    }
