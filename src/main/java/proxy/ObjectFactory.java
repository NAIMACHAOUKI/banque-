...
public class ObjectFactory {
    ...
    private final static QName _Convert_QNAME = new QName("http://BankServices/", "Convert");
    private final static QName _ConvertResponse_QNAME = new QName("http://BankServices/", "ConvertResponse");
    private final static QName _Compte_QNAME = new QName("http://BankServices/", "compte");
    private final static QName _GetCompte_QNAME = new QName("http://BankServices/", "getCompte");
    private final static QName _GetCompteResponse_QNAME = new QName("http://BankServices/", "getCompteResponse");
    private final static QName _ListCompte_QNAME = new QName("http://BankServices/", "listCompte");
    private final static QName _ListCompteResponse_QNAME = new QName("http://BankServices/", "listCompteResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://BankServices/", name = "Convert")
     ...
     */
    @XmlElementDecl(namespace = "http://BankServices/", name = "ConvertResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://BankServices/", name = "compte")
     ...
     */
    @XmlElementDecl(namespace = "http://BankServices/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://BankServices/", name = "getCompteResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://BankServices/", name = "listCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://BankServices/", name = "listCompteResponse")
